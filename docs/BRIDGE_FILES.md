...
Milestone 3 introduces an OpenAI Planning Chat foundation, and Milestone 4 introduces a GitHub repository-link foundation. Full bridge-file generation is still deferred. Bridge files should still be created and updated manually, then pasted into ChatGPT or Codex chats when context needs to move between sessions.
...
Milestone numbering note: Milestone 2 is the Local Projects component and is complete, passed, and successful. Milestone 3 is the OpenAI Planning Chat component. Milestone 4 is GitHub Integration. Do not infer milestone IDs from numbered-list positions.
