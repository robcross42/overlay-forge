...
Overlay Forge 0.2.0 is complete, passed, and successful as the GearBlocks runtime API interface release. It implements the documented `SmashHammer.GearBlocks.Construction` namespace reference interfaces for runtime export support, persists expanded getter snapshots in SQLite, and keeps catalog display limited to attribute availability.
