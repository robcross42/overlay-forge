...
use commands::{
    ...
    create_task, create_youtube_reference, decode_gearblocks_construction_file,
    decode_gearblocks_construction_folder, delete_calendar_event, delete_game,
    delete_game_build_guide, delete_game_character_build, delete_game_chat_conversation,
    delete_game_data_location, delete_game_screenshot, delete_note, delete_smoking_event,
    delete_task, delete_youtube_reference, export_smoking_cessation_chatgpt_context,
    ...
    get_overlay_forge_foreground_window_label, get_scratchpad, get_smoking_cessation_settings,
    ...
    install_gearblocks_lua_exporter, is_overlay_forge_foreground, list_calendar_events,
    ...
    list_gearblocks_runtime_exports, list_keybinds, list_notes, list_repair_resell_categories,
    list_repair_resell_deal_estimates, list_repair_resell_keyword_flags,
    list_repair_resell_listings, list_repair_resell_sources, list_repair_resell_travel_profiles,
    list_schedulers, list_smoking_events, list_tasks, list_youtube_references,
    manual_import_repair_resell_listing, open_game_build_guide_overlay_window,
    open_game_chat_overlay_window, open_youtube_reference, record_smoking_event,
    refresh_repair_resell_source, reset_keybinds, save_game_data_location,
    save_gearblocks_part_render_profile_from_capture, save_keybinds, save_openai_api_key,
    save_repair_resell_deal_estimate, save_scratchpad, send_game_chat_message,
    send_gearblocks_marker_commands, set_active_game_character_build,
    set_game_runtime_part_display_image, set_overlay_window_opacity,
    set_repair_resell_listing_watchlist, shutdown_app, start_manual_overlay_drag,
    start_scheduler_worker, sync_gearblocks_runtime_context, sync_gearblocks_saved_constructions,
    toggle_game_build_guide_overlay_window, toggle_game_chat_overlay_window, update_calendar_event,
    update_game_character_build, update_game_runtime_part_notes, update_note,
    update_repair_resell_source_enabled, update_smoking_cigarette_count, update_task,
    update_youtube_reference,
};
use db::AppDatabase;
use media::books::commands::{
    add_book_to_read_next, add_catalog_book_to_library, clear_book_series_override,
    create_book_link, create_manual_book_edition, create_manual_book_entry, delete_book_link,
    delete_manual_book_edition, get_book_library_detail, get_book_provider_status,
    list_book_library, mark_book_read, move_book_read_next_item, open_book_data_source,
    open_book_link, refresh_book_metadata, remove_book_from_read_next, reset_book_progress,
    search_book_catalog, set_book_preferred_edition, set_book_progress, set_book_series_override,
    set_preferred_book_link, update_book_link, update_book_reader_state,
    update_manual_book_edition,
};
use media::commands::{
...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            create_manual_book_entry,
            list_book_library,
            get_book_library_detail,
            refresh_book_metadata,
            update_book_reader_state,
            set_book_preferred_edition,
            set_book_progress,
            mark_book_read,
            reset_book_progress,
            add_book_to_read_next,
            remove_book_from_read_next,
            move_book_read_next_item,
            create_manual_book_edition,
            update_manual_book_edition,
            delete_manual_book_edition,
            create_book_link,
            update_book_link,
            delete_book_link,
            set_preferred_book_link,
            open_book_link,
            set_book_series_override,
            clear_book_series_override,
            get_book_provider_status,
            open_book_data_source,
            list_smoking_events,
